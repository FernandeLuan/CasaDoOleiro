...
function statusMeta(s){return {pending:['Em preparação','warning'],analysis:['Em análise','info'],adjustments:['Ajustes','warning'],meeting:['Planejamento aprovado','info'],approved:['Aprovado','success'],rejected:['Recusado','danger'],proposed:['Proposta','warning'],manager_confirmed:['Confirmada','success'],plan_approved:['Planejamento aprovado','info'],confirmed:['Confirmada','success'],change:['Mudança solicitada','warning'],change_requested:['Mudança solicitada','warning']}[s]||[s,'']}

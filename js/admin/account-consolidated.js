...
(function accountConsolidated(){
  ...
  function installStyles(){
    ...
    const style=document.createElement('style');style.id='accountConsolidatedStyles';style.textContent=`
      ...
      @media(max-width:720px){.planning-detail-page .account-person-sections-r70{grid-template-columns:1fr}.planning-detail-page .account-side-r70{grid-template-columns:1fr}.planning-detail-page .account-contact-card-r70>.account-person-row{padding:15px!important}}

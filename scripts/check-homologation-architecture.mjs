...
for(const forbiddenPath of ['homologacao','js/demo','build-preview.mjs','firebase.preview.json','js/admin/homologation-shell.js','css/planning-board-r65.css','css/planning-person-agenda-r66.css','css/desktop-r49.css','js/admin/meeting-activity-r52.js','js/portal/meeting-activity-r51.js','js/portal/candidate-adjustment-r37.js','js/services/history-hooks-r27.js','js/services/selection-flow-r25-service.js','js/admin/history-r27.js','js/admin/selection-flow-r25.js','js/admin/selection-ui-r27.js','js/portal/selection-flow-r25.js','js/services/planning-days-r17-service.js','js/admin/planning-days-r17.js','js/portal/planning-days-r17.js','js/services/consistency-r15-services.js','js/admin/consistency-r15.js','js/portal/consistency-r15.js','js/admin/confirm-r15.js','js/admin/review-signals-r31.js','js/admin/review-actions-r31.js','js/admin/review-polish-r31.js','js/admin/review-cards-r31.js','js/admin/activity-assistant-r31.js','js/admin/activity-assistant-hardening-r31.js','js/admin/review-flow-r32.js','css/round27.css','css/round3.css','css/round4.css','css/round5.css','css/round6.css','css/round7.css','css/round12.css','css/round15.css','css/round16.css','css/round18.css','css/round19.css','css/round20.css','css/round25.css','css/round31.css','css/round32.css','js/shared/i18n-r31.js','js/services/review-flow-r31b-service.js','js/services/review-flow-r31-service.js','js/admin/approved-lifecycle-r18.js','js/admin/refactor-r18.js','js/admin/refinements-r19.js','js/admin/refinements-r20.js','js/admin/refinements-r23.js','js/admin/ux-r16.js','js/portal/candidate-refactor-r18.js','js/portal/refinements-r20.js','js/portal/refinements-r23.js','js/portal/ux-r16.js','js/portal/review-flow-r31.js','js/services/planning-r22-service.js','js/shared/i18n-r25.js','js/shared/i18n-r27.js','js/login-round3.js','js/login-round4.js']){
  if(existsSync(forbiddenPath))violations.push(`artefato legado ainda versionado: ${forbiddenPath}`);
}
for(const required of ['scripts/build-site.mjs','js/admin/admin-shell.js','css/planning-board.css','css/planning-person-agenda.css','css/ui-foundation.css','css/workflow-foundation.css','css/admin-profile-refinements.css','css/workflow-refinements.css','css/login-foundation.css','css/login-workflow.css','js/admin/approved-lifecycle.js','js/admin/candidate-detail-data.js','js/admin/candidate-profile-details.js','js/admin/candidate-planning-management.js','js/admin/planning-review-controls.js','js/admin/admin-ux.js','js/portal/planning-enhancements.js','js/portal/review-safeguards.js','js/portal/portal-ux.js','js/portal/session-review-ui.js','js/services/planning-operations-service.js','js/shared/i18n-flow-compat.js','js/shared/i18n-keyed.js','js/shared/domain-rules.js']){
...
if(portalHtml.includes('../js/portal/candidate-view.js'))violations.push('Portal voltou a carregar candidate-view.js, aposentado após consolidar a regra em planejamento.js.');
if(!portalHtml.includes('../js/shared/domain-rules.js'))violations.push('Portal não carrega domain-rules.js.');
const planningEnhancements=readFileSync('js/portal/planning-enhancements.js','utf8');
if(/volunteerPlan\s*=\s*function/.test(planningEnhancements))violations.push('planning-enhancements.js não pode redefinir volunteerPlan.');
const adminShellSource=readFileSync('js/admin/admin-shell.js','utf8');
if(adminShellSource.includes('function planningDetailHtml('))violations.push('admin-shell.js voltou a duplicar o renderer de Planejamento.');
if(!adminShellSource.includes("typeof window.adminPlanningPageHtml==='function'"))violations.push('admin-shell.js não delega Planejamento ao módulo planning-page.js.');

...
test('Admin adjustment stays on one activity and volunteer resubmits that session',async({page})=>{
  ...
  await vcard.getByRole('button',{name:/Ajustar atividade/}).click();await page.locator('#r31ActTime').fill('16:00');await page.locator('#r31VolunteerAdjustSave').click();await page.getByRole('button',{name:/Reenviar planejamento/}).click();

...
async function addActivity(page,date,name,period){
  ...
  await page.locator('#actName').fill(name);await page.locator('#actPeriod').selectOption(period);await page.locator('#modalRoot').getByRole('button',{name:/Adicionar atividade/}).click();
